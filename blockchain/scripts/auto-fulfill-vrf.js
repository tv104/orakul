...
async function main() {
  const Magic8Ball = await ethers.getContractAt("Magic8Ball", "0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9");
  ...
  Magic8Ball.on("PredictionRequested", async (requestId, player, question) => {
    ...
    try {
      const contractAddress = await Magic8Ball.getAddress();
