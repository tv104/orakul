...
/**
 * @title Magic8VRF
 * @dev A contract that provides verifiable random Magic 8 outcomes using Chainlink VRF
 * There are 20 possible answers represented by an index.
 * The index is generated by the VRF Coordinator and is verifiable by the contract.
 */
contract Magic8VRF is VRFConsumerBaseV2 {
