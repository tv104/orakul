export const textInputStyles = {
    ...
    label: {
      base: "absolute pointer-events-none top-5 left-4 text-white text-lg text-shadow-md/20 transition-position duration-300 ease-out group-focus-within:-top-8",
