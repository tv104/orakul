export const textInputStyles = {
    container: {
      base: "mb-4 relative group hover:backdrop-grayscale-10",
      pseudo: {
        before:
      ...
      states: {
        focus:
          "focus-within:before:translate-y-[3px] focus-within:after:translate-y-[-3px] focus-within:before:bg-neutral-100 focus-within:after:bg-neutral-100 focus-within:backdrop-grayscale-20 focus-within:backdrop-blur-xs",
        dirty:
          "before:translate-y-[3px] after:translate-y-[-3px] before:bg-neutral-100 after:bg-neutral-100 backdrop-grayscale-20 backdrop-blur-xs",
      },
    },
    input:
